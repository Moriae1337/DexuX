namespace DexuXRenderer {
  ...
  export const ui = {
    ...
    selectionModal: getElementByIdOrThrow<HTMLElement>('selection-modal'),
    selectionModalOverlay: getElementByIdOrThrow<HTMLElement>('selection-modal-overlay'),
    selectionContent: getElementByIdOrThrow<HTMLDivElement>('selection-content'),
